    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            if(!InternetUtils.getInstance(PracticeTestActivity.this).available()){
                iv_status.setBackgroundResource(R.drawable.offline_textview);
            }else{
                iv_status.setBackgroundResource(R.drawable.online_textview);
            }
            ...
            if(b1!=null){
                int courseid = b1.getInt("courseid");
                Log.e("courseid ", String.valueOf(courseid));
                peakno = b1.getString("peakno");
                ...
                try {
                    ...
                    ConnectionManager.getInstance(PracticeTestActivity.this).getpracticetest(mainobj.toString(), type);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                //parseexamdata(courseid, peakno);
            }

            /*JSONArray array = DatabaseHelper.getInstance(PracticeTestActivity.this).getexaminationdatav1_practicetest(type, courseid, peakno);
            Log.e("exam data saved ", array.toString());*/
            ...
            /*sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    parseexamdata(coursedata.get(i).getCourse_id(), peakno);
    ...
    protected void onResponsed(int statuscode, int accesscode, String data) {
        ...
        try {
            if (statuscode == Constants.STATUS_OK) {
                if (accesscode == Connection.GET_PracticeTest.ordinal()) {
                    try {
                        Log.e("received ", "received GET_EXAMS" + GlobalValues.TEMP_STR);
                        try {
           ...
           /*         practiceTestModels.clear();
                ...
                } else if (accesscode == Connection.GET_PracticeTest_EXCEPTION.ordinal()) {
                    try {
