...
public class PracticeTestAdapter extends RecyclerView.Adapter<PracticeTestAdapter.MyViewHolder> implements Filterable {
    ...
    public PracticeTestAdapter(Context context, ArrayList<Exam> practiceTestModelsdata){
        try{
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.tv_attempt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(myViewHolder.tv_attempt.getText().equals("Attempt")){
                    ((Activitycommon)context).gotopracticeActivitytoAttempt(practiceTestModels.get(i));
                }
                else if(myViewHolder.tv_attempt.getText().equals("Resume")){
                    //((Activitycommon)context).gotopracticeActivitytoResume(practiceTestModels.get(i));
                    ((Activitycommon)context).gotopracticeActivitytoAttempt(practiceTestModels.get(i));
                }
                else if(myViewHolder.tv_attempt.getText().equals("Retry")){
                    ((Activitycommon)context).gotopracticeActivitytoRetry(practiceTestModels.get(i));
                }
            }
        });
        myViewHolder.lprogbar.setVisibility(View.VISIBLE);
