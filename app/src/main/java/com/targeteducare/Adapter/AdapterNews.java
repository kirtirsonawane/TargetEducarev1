...
public class AdapterNews extends RecyclerView.Adapter<AdapterNews.Holder> implements Filterable {
    Context context;
    ArrayList<SplashModel> splashModelArrayList = new ArrayList<>();

    ArrayList<SplashModel> list1;

    public AdapterNews(Context context, ArrayList<SplashModel> question) {
        try{
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int i) {
        try {
            ...
            // holder.enddate.setText("TO : "+splashModelArrayList.get(i).getToDate());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
