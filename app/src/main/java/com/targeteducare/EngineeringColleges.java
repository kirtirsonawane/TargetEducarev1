        ...
        compare_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sum > 1) {
                    ...
                    Intent i = new Intent(getApplicationContext(), College_Comparision.class);
                    ...
                    Toast.makeText(getApplicationContext(), "Pls select more than one college for comparision !!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
