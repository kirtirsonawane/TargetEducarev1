...
public class URLS {
   ...
   /* public static String getBaseUrl(){
    ...
    public static String GET_VALIDCOURSE(){
        return getBaseUrl1() + "Api_Student_GetValidCourse";
    }

    public static String GET_PracticeTest(){
        return getBaseUrl1() + "getexams_Api_PracticeTest";
    }
    ...
    public static String sendotp(String msg, String otp) {
        return "https://www.businesssms.co.in/SMS.aspx?ID=drpbansal@gmail.com&Pwd=Anuragdixit!@12&PhNo="+ msg +"&Text=" + otp;
    }
